...
const OrderList = React.createClass({
    ...
    render() {
        return (
            <div id="page-wrapper">
                <PageTitle pageTitle="评论管理"/>
                <div className="row">
                    <div className="search-wrap col-md-12">
                        <div className="form-inline">
                            <div className="form-group">
                                <select className="form-control">
                                    <option value="orderNumber">按ID号查询</option>
                                </select>
                            </div>
                            <div className="form-group">
                                <input type="text" className="form-control" placeholder="ID号" onChange={this.onOederNumberChange}/>
                            </div>
